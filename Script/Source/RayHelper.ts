namespace Script {
    ...
    export class RayHelper extends f.ComponentScript {
        ...
        private computeRay = (_webXRControllerTransform: f.ComponentTransform, rayNode: f.Node): void => {
            ...
            let ray: f.Ray = new f.Ray(new f.Vector3(0, 0, -1), new f.Vector3(2, 0, 1), 0.1);
